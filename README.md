- This is my working copy forked from the [official repository]( https://github.com/haskell/cabal).
- You might not want to clone this as I force-push and rebase it.
